...
<section class="placed-orders">
    ...
    <div class="box">
        ...
        <p> <span class='dataTitle'>Status do pagamento: </span><span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){echo 'tomato'; }else{echo 'green';} ?>"><?php echo $fetch_orders['payment_status']; ?></span> </p>
    </div>
    <?php
        }
    }else{
